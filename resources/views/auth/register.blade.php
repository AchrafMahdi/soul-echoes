<x-layout>
<div class="w-full max-w-md  p-6 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
    ...
    <div class="mt-5">
      ...
      <form method="post" action="/register">
        ...
        <div class="grid gap-y-4">
            <!-- Form Group -->
          <div>
            <label for="name" class="block text-sm mb-2 dark:text-white">Username</label>
            <div class="relative">
