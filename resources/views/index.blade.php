...
<section
    ...
    <div class="relative z-20 mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center">
            ...
            Soul Echoes:
                <span class="text-blue-600">A Journey Through My Thoughts
           </span>
            </h1>
            <h2 class="mt-6 text-lg leading-8 text-gray-300">
            Welcome to Soul Echoes, where I share the echoes of my thoughts, reflections, and experiences. Join me on this intimate journey through the pages of my personal journal
            </h2>
        ...
        <div class="relative mx-auto mt-10 max-w-lg">
            <img class="w-full rounded-2xl border border-gray-100 shadow"
             src=
             "https://images.unsplash.com/photo-1586380951230-e6703d9f6833?q=80&w=1287&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
             alt="">
        </div>
    </div>
</section>
